    ...
    for i in range(5,10):
        for j in range(0,10):
            ...
            for batch_images, batch_labels in dataloader:
                ...
                batch_images_random = np.random.normal(2, 1, batch_images.shape)
                batch_images = torch.tensor(batch_images_random, device=device, dtype=torch.float32)
            ...
            axs[1].set_title("FGSM (layer1 vs. layer4) NO MEANING")
